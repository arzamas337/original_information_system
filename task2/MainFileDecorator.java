...
public class MainFileDecorator {
    public static void main(String[] args) throws Exception {
        System.setOut(new PrintStream(System.out, true, StandardCharsets.UTF_8));
        MyClientRep baseRepo = new MyClientRepJson();

        MyClientRep filteredRepo = new FilterTypePropertyFileDecorator(baseRepo);
        ...
        MyClientRep sortedRepo = new SortOrganizationNameFileDecorator(baseRepo);
        ...
        MyClientRep filteredSortedRepo = new SortOrganizationNameFileDecorator(filteredRepo);
